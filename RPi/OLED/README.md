...
if len(sys.argv) > 1:
    ...
    print("please specify the location of image i.e img2bytearray.py /path/to/image width height")
  ```

### Show images from bytes
  ```python
...
data = b'\x00...<bytes from the code above>....'
logo = Image.frombytes(mode='1', data=data, size=(128, 32))
